...
export const archive = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        // Archive the parent inclusive of its children.
        const recursiveArchive = async(documentId: Id<"documents">) => {
            // Fetch all children of parent documentId
            ...
            // Delete/Archive each of them
            for (const child of children){
                await ctx.db.patch(child._id, {
                    isArchived: true,
                })
                // Confirm if the child has its children and archive them.
